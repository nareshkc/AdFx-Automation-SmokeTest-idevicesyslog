...
public class SmokeTest_C414339_Thirdparty_Beacon extends Driver{
	...
	public void Thirdpart()throws IOException, InterruptedException
	{
		...
		logger = reporter.startTest("Verify Third party Beacon test case").assignCategory("Smoke_Test");
...
//		Thread.sleep(5000);
		...
		try {
			...
			for ( String word : splitWords ) {
				...
				logger.log(LogStatus.PASS, "Verify creative ID");
									...
									for(String beaconlist:arraybeacon){
										...
										if(beaconlist.contains("=")){
											...
											}else if(beaconkey[0].contains("clickThru"))
											{
												...
												System.out.println("=====================================================");
												logger.log(LogStatus.PASS, "Verify creative ID present");
											}
										}
