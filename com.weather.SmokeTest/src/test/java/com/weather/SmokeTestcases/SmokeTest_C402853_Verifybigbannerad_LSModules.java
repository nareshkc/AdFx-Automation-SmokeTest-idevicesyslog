...
public class SmokeTest_C402853_Verifybigbannerad_LSModules  extends Driver{
	...
	public void verify_adpresent_onLSModule_page() throws InterruptedException, IOException
	{
...
//		Ad.context("NATIVE_APP");
		...
		for(int page =1 ; page<=10;page++)
		{
			...
			{   
				...
				Ad.findElementByXPath("//UIAApplication[1]/UIAWindow[1]/UIACollectionView[1]/UIACollectionCell[1]/UIACollectionView[1]/UIACollectionCell[11]/UIAButton[2]").click();
