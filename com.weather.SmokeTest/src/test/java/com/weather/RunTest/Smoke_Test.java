...
import com.weather.servertest.SmokeTest_C334145_factualCall_Server;
import com.weather.servertest.SmokeTest_C334153_LotameServer;
import com.weather.Genaral.Clear_logs;
import com.weather.Genaral.User_Login;
...
//		UL.login();
	...
	public void c334145_factualCall_onfreshlaunch() throws Exception{
		...
		//enable for server build
		SmokeTest_C334145_factualCall_Server c334145 = new SmokeTest_C334145_factualCall_Server();
		c334145.verify_facualcal_onfresh_launch();


		//enable for hockey app build
...
//		c334153.Verify_Lotamecall_onapp_launch();
		...
		//Servr Build app
		SmokeTest_C334153_LotameServer LotameServ = new SmokeTest_C334153_LotameServer();
		LotameServ.Lotame_server();
	}
